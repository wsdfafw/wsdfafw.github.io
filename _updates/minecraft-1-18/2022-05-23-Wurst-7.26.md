...
- 在[ChestESP](https://wiki.wurstclient.net/chestesp)中增加了对<a href="https://minecraft.fandom.com/wiki/Boat_with_Chest" target="_blank">船带箱子</a>的支持。(22w18a及以后的版本)

- 修正了加入或离开服务器时<a href="https://github.com/Wurst-Imperium/Wurst7/issues/646" target="_blank" >罕见的崩溃</a>。

- 修正了切换[搜索](https://wiki.wurstclient.net/search)时日志中出现的OpenGL错误。
...
- [ClickGUI](https://wiki.wurstclient.net/clickgui) (按'右CTRL'打开).

- [Navigator](https://wiki.wurstclient.net/navigator) (按'右Shift'打开).
