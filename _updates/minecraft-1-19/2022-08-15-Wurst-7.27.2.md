...
- <del>修复了在启用 [NoChatReports](https://wurst.wiki/nochatreports) 时尝试在 Minehut 上聊天时出现的神秘错误消息。 (MC 1.19+)</del> **更新：** Minehut 现在已经解决了这个问题。 使用 NoChatReports 时，他们将不再踢你。
...
- 修正[AnchorAura](https://wurst.wiki/anchoraura) 和[CrystalAura](https://wurst.wiki/crystalaura) 过滤器设置描述中的一些错别字。
